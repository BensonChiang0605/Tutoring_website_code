...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request', sender='benson0605@gmail.com', recepients=[user.email])
...
def reset_request():
    ...
    if form.validate_on_submit:
        ...
        flash('Password reset email sent to your email', 'info')
        return redirect(url_for('login'))
    return render_template('reset_password.html', title='Reset Password', posts=posts, form=form)
...
def reset_token():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('login'))
    return render_template('reset_token.html', title='Reset Password', posts=posts, form=form)
